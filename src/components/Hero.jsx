  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 px-6`}>
            ...
            <h1 className='w-full font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]'>
                Payment Method.
            </h1>
        ...
        <div className={`flex-1 ${styles.flexCenter} md:my-0 my-10 realtive`}>
